...
RcppExport SEXP _MSstatsLiP_extract_protein_name(SEXP ptm_listSEXP, SEXP protein_listSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_MSstatsLiP_extract_protein_name", (DL_FUNC) &_MSstatsLiP_extract_protein_name, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_MSstatsLiP(DllInfo *dll) {
