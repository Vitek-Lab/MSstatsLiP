...
``` {r}
## TODO: ensure condition isnt continuous
## Run converter
...
``` {r}
trypticHistogramLiP(MSstatsLiP_data, "../inst/extdata/ExampleFastaFile.fasta",
                    address = FALSE)
```

#### 1.4 Run Correlation Plot

MSstatsLiP also provides a function to plot run correlation.

``` {r}
correlationPlotLiP(MSstatsLiP_data, method = "kendall", address = FALSE)
```
...
BarcodePlotLiP(MSstatsLiP_model, "../inst/extdata/ExampleFastaFile.fasta", 
               model_type = "Adjusted", which.prot = c("P04050"), 
               address = FALSE)
