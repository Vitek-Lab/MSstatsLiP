...
data.table::setnames(feature_data, c("PEPTIDE", "PROTEIN"), c("PeptideSequence", "ProteinName"))
...
MSstatsLiP_model[["Adjusted.LiP.Model"]] %>% filter(adj.pvalue < .05) %>% nrow()
...
BarcodePlotLiP(MSstatsLiP_model, "../inst/extdata/ExampleFastaFile.fasta", 
               model_type = "Adjusted", which.prot = c("P53235"),# FT.only = FALSE,
               address = FALSE)
