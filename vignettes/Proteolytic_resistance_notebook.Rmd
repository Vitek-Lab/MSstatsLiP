...
*Note*: The example dataset was very limited in size due to what could be included in the package. Thus some of the plots and results look different then what they would appear with a full dataset.
